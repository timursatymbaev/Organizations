                    ...
                    <form action="{{ route('ministries.update', $ministry->id) }}" method="post">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label for="ministry_name" class="block mb-4 text-md font-medium text-gray-900 dark:text-black">Введите новое название министерства (либо введите старое, если не меняете название)</label>
