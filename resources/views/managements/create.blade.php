                    ...
                    <form action="{{ route('managements.store')  }}" method="post">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label for="management_name" class="block mb-4 text-md font-medium text-gray-900 dark:text-black">Название управления</label>
                                <input type="text" name="management_name" id="management_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Введите название управления">
                            </div>
                            <div class="sm:col-span-2">
                                <label for="ministry_id" class="block mb-4 text-md font-medium text-gray-900 dark:text-black">Выберите курирующее вас министерство</label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="committee_id" class="block mb-4 text-md font-medium text-gray-900 dark:text-black">Выберите курирующий вас комитет</label>
                                <select name="committee_id" id="committee_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option value="">Выберите курирующий вас комитет</option>
